...
const en: Dict = {
  ...
  items: {
    ...
    "svc-announcements": { label: "Announcements", hint: "Giveaways, launches and updates" },
  ...
  auth: {
    ...
    perks: {
      ...
      warranty: "1-year warranty on every product",
    },
    email: "Email address",
    password: "Password",
    firstName: "First name",
...
const az: Dict = {
  ...
  items: {
    ...
    "svc-announcements": { label: "Elanlar", hint: "Çəkilişlər, yeniliklər və məlumatlar" },
  ...
  auth: {
    ...
    perks: {
      ...
      warranty: "Hər məhsula 1 illik zəmanət",
    },
    email: "E-poçt ünvanı",
    password: "Parol",
    firstName: "Ad",
...
const ar: Dict = {
  ...
  items: {
    ...
    "svc-announcements": { label: "الإعلانات", hint: "سحوبات وإطلاقات وتحديثات" },
  ...
  auth: {
    ...
    perks: {
      ...
      warranty: "ضمان سنة واحدة على كل منتج",
    },
    email: "البريد الإلكتروني",
