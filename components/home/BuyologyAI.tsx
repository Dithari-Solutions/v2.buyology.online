    ...
    >
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="relative flex min-h-[220px] flex-col justify-between overflow-hidden rounded-2xl bg-gradient-to-br from-brand to-brand-deep p-6 text-white sm:col-span-2">
          ...
          <Link
            href="/buyobot"
            className="relative mt-4 inline-flex w-fit items-center gap-2 rounded-full bg-primary px-5 py-2.5 text-sm font-semibold text-primary-fg transition-colors hover:bg-primary-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 focus-visible:ring-offset-brand-deep"
          >
            {t.ai.cta}
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-brand-soft text-brand-icon transition-colors group-hover:bg-primary group-hover:text-primary-fg">
